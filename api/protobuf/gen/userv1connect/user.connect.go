...
var (
	userServiceServiceDescriptor    = gen.File_user_proto.Services().ByName("UserService")
...
func (c *userServiceClient) List(ctx context.Context, req *connect.Request[gen.ListRequest]) (*connect.Response[gen.ListResponse], error) {
...
func (UnimplementedUserServiceHandler) List(context.Context, *connect.Request[gen.ListRequest]) (*connect.Response[gen.ListResponse], error) {
